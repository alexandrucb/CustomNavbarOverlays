...
Java_navbar_overlay_substratum_SubstratumLauncher_getAPKSignatureProduction(JNIEnv *env) {
 ...
 */
JNIEXPORT jstring JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getBase64Key(JNIEnv *env) {
...
Java_navbar_overlay_substratum_SubstratumLauncher_getInternetCheck(JNIEnv *env) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getGooglePlayRequirement(JNIEnv *env) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getAmazonAppStoreRequirement(JNIEnv *env) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getBlacklistedApplications(JNIEnv *env) {
 ...
 */
JNIEXPORT jboolean JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_allowThirdPartySubstratumBuilds(JNIEnv *env) {
    return ALLOW_THIRD_PARTY_SUBSTRATUM_BUILD;
}

JNIEXPORT jbyteArray JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getDecryptionKey(JNIEnv *env) {
...
JNIEXPORT jbyteArray JNICALL
Java_navbar_overlay_substratum_SubstratumLauncher_getIVKey(JNIEnv *env) {
    jbyteArray ret = (*env)->NewByteArray(env, 16);
